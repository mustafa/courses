# RL for LLMs: Building Coursera's AI Moat
...
| Model Family | Key Sizes | License | Strengths | Best For |
| --- | --- | --- | --- | --- |
| Llama 3.x (Meta) | 8B, 70B, 405B | Llama 3 Community | Broad capability, huge community | General fine-tuning, production |
| Mistral / Mixtral | 7B, 8x7B, 8x22B | Apache 2.0 | Efficiency, MoE architecture | Cost-sensitive deployment |
| Qwen 2.5 (Alibaba) | 7B, 14B, 72B | Apache 2.0 | Multilingual, strong reasoning | Global education platform |
| Gemma 2 (Google) | 2B, 9B, 27B | Gemma license | Small but capable, research-friendly | Edge/mobile, experimentation |
| Phi-3/4 (Microsoft) | 3.8B, 14B | MIT | Punches above weight class | Rapid prototyping, cost control |

> **Tip:** ℹ️ Recommendation
>
...
| Task | Minimum GPU | Recommended | Cloud Cost (approx) |
| --- | --- | --- | --- |
...
-   [Llama 3 paper](https://arxiv.org/abs/2407.21783) — Meta's training methodology
-   [Hugging Face Transformers documentation](https://huggingface.co/docs/transformers) — Your daily reference
-   Chip Huyen, "Designing Machine Learning Systems" — Chapter on model selection
-   [The Bitter Lesson](http://www.incompleteideas.net/IncIdeas/BitterLesson.html) (Rich Sutton) — Why scale matters
...
-   [LIMA: Less Is More for Alignment](https://arxiv.org/abs/2305.11206) — Shows 1000 high-quality examples can go far
-   [TRL documentation](https://huggingface.co/docs/trl) — Your main library reference
...
L = -E\[log σ(r(x, y\_w) - r(x, y\_l))\]

where y\_w is the chosen (winning) response and y\_l is the rejected (losing) response.
...
-   [Training language models to follow instructions with human feedback](https://arxiv.org/abs/2203.02155) (InstructGPT, Ouyang et al., 2022) — The original RLHF paper
-   [Scaling Laws for Reward Model Overoptimization](https://arxiv.org/abs/2210.10760) — Why bigger isn't always better for reward models
-   [RLAIF: Reinforcement Learning from AI Feedback](https://arxiv.org/abs/2309.00267) — Using AI to generate preferences at scale
...
> **Warning:** ⚠️ Warning: Without KL Penalty
>
...
objective = E\[r(x, y)\] - β · D\_KL(π\_θ ‖ π\_ref)
...
| --- | --- | --- |
| Reward increases but quality decreases | Reward hacking | Increase KL coefficient, improve reward model |
| KL divergence explodes | Learning rate too high | Reduce LR, increase init_kl_coef |
| No improvement in reward | KL penalty too strong | Reduce beta, or reward model isn't discriminative enough |
| Repetitive outputs | Mode collapse | Increase temperature, add entropy bonus |
| Training is unstable (reward oscillates) | Batch size too small | Increase batch size, reduce LR |
...
> **Tip:** ℹ️ Skip RLHF (use DPO instead) when:
>
...
-   [InstructGPT paper](https://arxiv.org/abs/2203.02155) — The canonical RLHF implementation
-   [Secrets of RLHF in Large Language Models Part I](https://arxiv.org/abs/2307.04964) — Practical tricks
...
L\_DPO = -E\[log σ(β log π\_θ(y\_w|x)/π\_ref(y\_w|x) - β log π\_θ(y\_l|x)/π\_ref(y\_l|x))\]
...
| Aspect | RLHF (PPO) | DPO |
| --- | --- | --- |
| Compute cost | 4-8x SFT | 1.5-2x SFT |
| GPU memory | Need 3+ models in memory | Need 2 models |
| Stability | Finicky, many hyperparameters | Stable, few hyperparameters |
| Quality ceiling | Slightly higher (in theory) | 90-95% of RLHF quality |
| Iteration speed | Days per experiment | Hours per experiment |
...
For prompt x, generate G responses: y₁, y₂, ..., yG Score each: r₁, r₂, ..., rG Normalize scores within group: advantage\_i = (r\_i - mean(r)) / std(r) Update policy to increase probability of high-advantage responses
...
-   [Let's Verify Step by Step](https://arxiv.org/abs/2305.20050) (Lightman et al., 2023) — Process reward models
-   [Math-Shepherd: Verify and Reinforce LLMs Step-by-step without Human Annotations](https://arxiv.org/abs/2312.08935)
-   [GRPO in TRL](https://huggingface.co/docs/trl/grpo_trainer)
...
> **Warning:** ⚠️ Key Considerations for Educational AI Data
>
...
-   [Scaling Data-Constrained Language Models](https://arxiv.org/abs/2305.16264) — How to maximize limited data
-   [RLHF Workflow: From Reward Modeling to Online RLHF](https://arxiv.org/abs/2405.07863) — Continuous training
-   [Data Flywheels for LLMs](https://www.latent.space/p/data-flywheels) — Strategic overview
...
| Tool | Best For | Throughput | Latency | Ease |
| --- | --- | --- | --- | --- |
| vLLM | Production at scale | Very high (PagedAttention) | Low | Medium |
| TGI (HuggingFace) | Quick deployment | High | Low | Easy |
| Ollama | Local dev/testing | Medium | Medium | Very easy |
| SGLang | Complex pipelines | Very high | Very low | Medium |
...
> **Tip:** ℹ️ Latency Targets for Real-Time Tutoring
>
...
| --- | --- | --- |
| SFT model quality | 20% | Follows teaching format, factually accurate |
| DPO/GRPO improvement | 25% | Measurable improvement over SFT baseline |
| Agentic system design | 20% | Tool use works, student state updates, adapts |
| Deployment readiness | 15% | Quantized, served, latency acceptable |
| Strategy memo | 20% | Clear, actionable, technically grounded |

## Appendices

### Appendix A: Compute Budget Summary

| Module | Exercise | Min GPU | Time | Approx Cost |
| --- | --- | --- | --- | --- |
| 1 | Model exploration | 1x A10G | 1 hr | $1 |
| 2 | QLoRA SFT | 1x A100 40GB | 3 hrs | $8 |
| 3 | Reward model | 1x A100 40GB | 2 hrs | $6 |
| 4 | Full RLHF/PPO | 2x A100 80GB | 6 hrs | $50 |
| 5 | DPO training | 1x A100 80GB | 3 hrs | $10 |
| 6 | GRPO training | 2x A100 80GB | 5 hrs | $35 |
| 7 | Agentic system | 1x A100 40GB | 2 hrs | $5 |
| 9 | Deployment | 1x A10G | 2 hrs | $2 |
| 10 | Capstone | 2x A100 80GB | 10 hrs | $80 |
| Total |  |  | ~35 hrs | ~$200 |
...
2.  **DPO** — Rafailov et al., 2023. [arxiv.org/abs/2305.18290](https://arxiv.org/abs/2305.18290)
3.  **DeepSeek-R1** — DeepSeek, 2025. [arxiv.org/abs/2501.12948](https://arxiv.org/abs/2501.12948)
4.  **Constitutional AI** — Bai et al., 2022. [arxiv.org/abs/2212.08073](https://arxiv.org/abs/2212.08073)
5.  **LoRA** — Hu et al., 2021. [arxiv.org/abs/2106.09685](https://arxiv.org/abs/2106.09685)
6.  **QLoRA** — Dettmers et al., 2023. [arxiv.org/abs/2305.14314](https://arxiv.org/abs/2305.14314)
7.  **PPO** — Schulman et al., 2017. [arxiv.org/abs/1707.06347](https://arxiv.org/abs/1707.06347)
8.  **ORPO** — Hong et al., 2024. [arxiv.org/abs/2403.07691](https://arxiv.org/abs/2403.07691)
9.  **vLLM** — Kwon et al., 2023. [arxiv.org/abs/2309.06180](https://arxiv.org/abs/2309.06180)
10.  **LIMA** — Zhou et al., 2023. [arxiv.org/abs/2305.11206](https://arxiv.org/abs/2305.11206)

...
python · event\_handler.py — Full SSE Event Handler
...
python · agents/calendar\_agent.py
...
python · agents/calendar\_agent.py (continued) — Running a session
...
python · agents/notification\_agent.py
...
python · agents/research\_agent.py
...
python · agents/browser\_agent.py
...
python · dispatcher/imessage\_listener.py
...
python · dispatcher/morning\_digest.py
...
┌──────────────────────────────────────────────────────────────────┐ │ MCP ARCHITECTURE │ │ │ │ ┌─────────────────┐ MCP Protocol (JSON-RPC 2.0) │ │ │ Agent Session │ ◄──────────────────────────────────────┐ │ │ │ (Claude model) │ │ │ │ └────────┬────────┘ │ │ │ │ tool\_call │ │ │ ▼ │ │ │ ┌─────────────────────────────────────────────────────┐ │ │ │ │ MCP CLIENT (inside agent runtime) │ │ │ │ └──────┬──────────────┬──────────────┬───────────────-┘ │ │ │ │ │ │ │ │ │ ▼ ▼ ▼ │ │ │ ┌────────────┐ ┌────────────┐ ┌────────────┐ │ │ │ │ Gmail MCP │ │Calendar MCP│ │iMessage MCP│ │ │ │ │ Server │ │ Server │ │ Server │ │ │ │ │ │ │ │ │ │ │ │ │ │ Tools: │ │ Tools: │ │ Tools: │ │ │ │ │ search() │ │ list() │ │ send() │ │ │ │ │ read() │ │ create() │ │ read() │ │ │ │ │ draft() │ │ update() │ │ search() │ │ │ │ └─────┬──────┘ └─────┬──────┘ └─────┬──────┘ │ │ │ │ │ │ │ │ │ ▼ ▼ ▼ │ │ │ Gmail API Google Cal API macOS Messages DB │ │ └──────────────────────────────────────────────────────────────────┘
...
python · mcp\_connections.py — Connecting Multiple MCP Servers
...
python · mcp\_servers/imessage\_server.py — Complete Custom MCP Server
...
python · mcp\_servers/web\_search\_server.py — Web Search MCP
...
python · config/model\_tiers.py — Cost-Optimized Model Selection
